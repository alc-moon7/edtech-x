...
const sections = [
  ...
  },
  {
    ...
    content: {
      en: "If you have questions about privacy, contact contact@homeschool.com. We may update this policy and will post changes here.",
      bn: "গোপনীয়তা সম্পর্কে প্রশ্ন থাকলে contact@homeschool.com এ যোগাযোগ করুন। আমরা এই নীতি আপডেট করতে পারি এবং পরিবর্তন এখানে জানাব।",
    },
  },
];
